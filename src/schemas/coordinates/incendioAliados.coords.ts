...
// src/assets/templates/incendio-aliados.pdf` (page: 612.12 x 1008.12pt, legal size).
// Every label position matched riesgos-varios.pdf exactly — same Word master template,
// only the "SECCIÓN INCENDIO" line differs — so these values are identical to
// riesgosVarios.coords.ts, verified field by field rather than assumed.
const FONT_SIZE = 9.5;
const RIGHT_MARGIN = 522;

export const incendioAliadosCoords: DenunciaCoordinateMap = {
