...
// src/assets/templates/transporte-mercaderias.pdf` (page: 612.12 x 1008.12pt, legal
// size). Same visual layout as Riesgos Varios but exported separately from Word, so the
// vertical rhythm of the lower half of the page differs slightly — calibrated on its own.
const FONT_SIZE = 9.5;
const RIGHT_MARGIN = 522;

export const transporteCoords: DenunciaCoordinateMap = {
  ...
  danosATerceros: [
    { x: 202.95, y: 554.25, render: "circle", radiusX: 9, radiusY: 7.5 },
    { x: 241.26, y: 554.25, render: "circle", radiusX: 11.5, radiusY: 7.5 },
  ],
  ...
  autoridadPolicial: [
    { x: 274.95, y: 455.59, render: "circle", radiusX: 9, radiusY: 7.5 },
    { x: 313.26, y: 455.59, render: "circle", radiusX: 11.5, radiusY: 7.5 },
  ],
  testigos: [
    { x: 166.92, y: 405.91, render: "circle", radiusX: 9, radiusY: 7.5 },
    { x: 205.26, y: 405.91, render: "circle", radiusX: 11.5, radiusY: 7.5 },
  ],
  datosTestigos: {
    x: 89.9,
    y: 370.09,
  ...
  fechaDenuncia: { x: 195, y: 337.25, maxWidth: RIGHT_MARGIN - 195, fontSize: FONT_SIZE },
  firma: { x: 312, y: 311, maxWidth: 200, maxHeight: 34, render: "image" },
};
