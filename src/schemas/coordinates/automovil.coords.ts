...
//  - the map image, which replaces the ENTIRE 3x2 "croquis" grid (empty rectangles with
//    no field behind them, between the "Circunstancias" field that ends at y=634 and the
//    "DATOS DEL VEHÍCULO ASEGURADO" header at y=467.81) — full width, not just one box.
